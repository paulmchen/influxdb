...
const createVariableHeader =
  '[data-testid=\'tabbed-page--header\'] [data-testid=add-resource-button]';
...
const createVariableEmpty =
  '[data-testid=resource-list--body] [data-testid=add-resource-button]';
const createVariableItem = '[data-testid=add-resource-dropdown--%ITEM%]';
const variableCardNamed =
  '//*[@data-testid=\'resource-card variable\'][.//*[text()=\'%NAME%\']]';
const variableCardNames = '[data-testid^=\'variable-card--name\'] span';
const variableCardName =
  '//*[@data-testid=\'variable-card--name %NAME%\']//span[text()=\'%NAME%\']';
const variableCardContextMenu =
  '//*[@data-testid=\'resource-card variable\'][.//span[text()=\'%NAME%\']]//*[@data-testid=\'context-menu\']';
const variableCardContextMenuItem =
  '//*[@data-testid=\'resource-card variable\'][.//span[text()=\'%NAME%\']]//*[button[@data-testid=\'context-menu\']]//button[text()=\'%ITEM%\']';
const variableCardContextDelete =
  '//*[@data-testid=\'resource-card variable\'][.//span[text() = \'%NAME%\']]//*[@data-testid=\'context-delete-menu\']';
const variableCardContextDeleteConfirm =
  '//*[@data-testid=\'resource-card variable\'][.//span[text() = \'%NAME%\']]//*[@data-testid=\'context-delete-variable\']';

const urlCtx = 'variables';

// import variable popup
const uploadRadioButton =
  '[data-testid=overlay--body] [data-testid=select-group--option][title=Upload]';
const pasteRadioButton =
  '[data-testid=overlay--body] [data-testid=select-group--option][title=Paste]';
const dragNDropFile = 'input[type=file]'; //N.B. has display:none
const importButton =
  '[data-testid=overlay--footer] [data-testid=\'submit-button Variable\']';
const pasteJSONTextarea =
  '[data-testid=overlay--body] [data-testid=import-overlay--textarea]';
const importVariableDragNDropHeader = '.drag-and-drop--header';

// create variable popup
const createVarPopupCreateButton =
  '[data-testid=overlay--container] button[title=\'Create Variable\']';
const createVariableNameInput =
  '[data-testid=overlay--body] [data-testid=input-field]';
const createVariableTypeDropdown =
  '[data-testid=\'variable-type-dropdown--button\']';
...
const createVariableTextArea =
  '[data-testid=overlay--body] [data-testid=textarea]';
const createVariableTypeDropdownItem =
  '[data-testid=\'variable-type-dropdown-%ITEM%\']';
const createVariableDefaultValDropdown =
  '//*[@data-testid=\'form--element\'][.//*[text() = \'Select A Default\']]//*[contains(@data-testid,\'dropdown--button\')]';
const createVariableInfoPara =
  '//*[@data-testid=\'grid--column\'][p[contains(text(), \'ontains\')]]';
const createVariableDefaultValDropdownItem =
  '[data-testid=dropdown-item][id=\'%ITEM%\']';
const createVariableDefaultValCSVDropdownItem =
  '//*[@data-testid=\'dropdown-item\']//*[text() = \'%ITEM%\']';

// edit variable popup
const editVariableTypeDropdown =
  '[data-testid=\'variable-type-dropdown--button\']';
const editVariableTypeDropdownItem =
  '[data-testid=\'variable-type-dropdown-%ITEM%\']';
const editVariableNameInput =
  '//*[@data-testid=\'form--element\'][.//*[text()=\'Name\']]//input';
...
//Warning popup
const updateNameNameInput =
  '[data-testid=overlay--body] [data-testid=rename-variable-input]';
...
class variablesTab extends settingsPage {
    ...
    async getCreateVariableItem(item) {
        return await this.driver.findElement(
            By.css(createVariableItem.replace('%ITEM%', item))
        );
    }
    ...
    async getCreateVariableTypeDropdownItem(item) {
        return await this.driver.findElement(
            By.css(
                createVariableTypeDropdownItem.replace('%ITEM%', item.toLowerCase())
            )
        );
    }
    ...
    async getCreateVariableDefaultValDropdown() {
        return await this.driver.findElement(
            By.xpath(createVariableDefaultValDropdown)
        );
    }
    ...
    async getVariableCardNamed(name) {
        return await this.driver.findElement(
            By.xpath(variableCardNamed.replace('%NAME%', name))
        );
    }
    ...
    static getVariableCardSelectorByName(name) {
        return {
            type: 'xpath',
            selector: variableCardNamed.replace('%NAME%', name),
        };
    }

    async getCreateVariableDefaultValDropdownItem(item) {
        return await this.driver.findElement(
            By.css(createVariableDefaultValDropdownItem.replace('%ITEM%', item))
        );
    }

    async getCreateVariableDefaultValCSVDropdownItem(item) {
        return await this.driver.findElement(
            By.xpath(createVariableDefaultValCSVDropdownItem.replace('%ITEM%', item))
        );
    }
    ...
    async getVariableCardName(name) {
        return await this.driver.findElement(
            By.xpath(variableCardName.replace(/%NAME%/g, name))
        );
    }
    ...
    async getVariableCardContextMenu(name) {
        return await this.driver.findElement(
            By.xpath(variableCardContextMenu.replace('%NAME%', name))
        );
    }
    ...
    async getEditVariableTypeDropdownItem(item) {
        return await this.driver.findElement(
            By.css(editVariableTypeDropdownItem.replace('%ITEM%', item.toLowerCase()))
        );
    }
    ...
    async getVariableCardContextDelete(name) {
        return await this.driver.findElement(
            By.xpath(variableCardContextDelete.replace('%NAME%', name))
        );
    }

    async getVariableCardContextDeleteConfirm(name) {
        return await this.driver.findElement(
            By.xpath(variableCardContextDeleteConfirm.replace('%NAME%', name))
        );
    }
